...
- Admins can opt in to per-file `webViewUrl` links for supported text-like files, images, and audio with `share.filesJsonWebViewLinksEnabled`; these render inline without extra page chrome
