export default {
  ...
  "home.bullet.a.description": "Hospede o Better Pingvin Share em sua própria máquina.",
  ...
  "admin.config.config-file-warning.description": "Como você tem um Better Pingvin Share configurado com um arquivo de configuração, você não pode alterar a configuração através da UI.",
  ...
  "admin.config.general.app-url.description": "Em qual URL o Better Pingvin Share está disponível",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente informações de caches Better Pingvin Share na memória. Se você executar várias instâncias do Better Pingvin Share, você precisa habilitar o cache do Redis para compartilhar o cache entre as instâncias.",
