export default {
  ...
  "home.bullet.a.description": "Better Pingvin Share працює на вашій машині.",
  ...
  "admin.config.config-file-warning.description": "Оскільки у вас налаштовано Better Pingvin Share за допомогою конфігураційного файлу, ви не можете змінювати конфігурацію через інтерфейс користувача.",
  ...
  "admin.config.general.app-url.description": "Адреса, на якій доступний Better Pingvin Share",
