export default {
  ...
  "home.bullet.a.description": "Hosti Better Pingvin Share oma seadmes.",
  ...
  "admin.config.config-file-warning.description": "Kuna teil on konfigureeritud Better Pingvin Share konfiguratsioonifailiga, ei saa te muuta konfiguratsiooni kasutajaliidest kasutades.",
  ...
  "admin.config.general.app-url.description": "URL, mille kaudu Better Pingvin Share on kättesaadav",
