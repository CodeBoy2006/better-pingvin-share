export default {
  ...
  "home.bullet.a.description": "โฮสต์ Better Pingvin Share บนเครื่องของคุณเอง.",
  ...
  "admin.config.general.app-url.description": "URL ที่สามารถเข้าถึงแอพพลิเคชัน Better Pingvin Share ได้",
