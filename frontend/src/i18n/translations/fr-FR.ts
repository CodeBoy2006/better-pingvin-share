export default {
  ...
  "home.bullet.a.description": "Hébergez Better Pingvin Share sur votre propre machine.",
  ...
  "admin.config.config-file-warning.description": "Puisque vous avez configuré Better Pingvin Share avec un fichier de configuration, vous ne pouvez pas modifier la configuration via l'interface utilisateur.",
  ...
  "admin.config.cache.redis-enabled.description": "Usuellement, Better Pingvin Share conserve les informations en mémoire vive. Si vous exécutez plusieurs instances de Better Pingvin Share, vous devez activer la mise en cache Redis pour partager le cache entre ces instances.",
