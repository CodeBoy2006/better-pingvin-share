export default {
  ...
  "home.bullet.a.description": "Хостујте Better Pingvin Share на својој машини.",
  ...
  "admin.config.general.app-url.description": "На којој URL адреси је доступан Better Pingvin Share",
