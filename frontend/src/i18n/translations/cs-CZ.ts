export default {
  ...
  "home.bullet.a.description": "Hostujte Better Pingvin Share na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je Better Pingvin Share nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je Better Pingvin Share k dispozici",
