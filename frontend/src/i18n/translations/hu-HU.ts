export default {
  ...
  "home.bullet.a.description": "A Better Pingvin Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A Better Pingvin Share megosztáskezelőre mutató hivatkozás",
