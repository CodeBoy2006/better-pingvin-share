export default {
  ...
  "home.bullet.a.description": "Hosta Better Pingvin Share på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad Better Pingvin Share med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL Better Pingvin Share finns",
