export default {
  ...
  "home.bullet.a.description": "Gostuj Better Pingvin Share na svoji lastni napravi.",
  ...
  "admin.config.general.app-url.description": "Na katerem URL-ju je dostopen Better Pingvin Share",
