export default {
  ...
  "home.bullet.a.description": "Aloja Better Pingvin Share en tu propio equipo.",
  ...
  "admin.config.config-file-warning.description": "Como tienes configurado Better Pingvin Share con un archivo de configuración, no puedes cambiar la configuración a través de la interfaz gráfica.",
  ...
  "admin.config.general.app-url.description": "En cuál URL está disponible Better Pingvin Share",
