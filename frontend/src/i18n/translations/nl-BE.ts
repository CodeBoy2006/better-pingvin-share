export default {
  ...
  "home.bullet.a.description": "Host Better Pingvin Share op uw eigen machine.",
  ...
  "admin.config.general.app-url.description": "De URL waar Better Pingvin Share bereikbaar is",
