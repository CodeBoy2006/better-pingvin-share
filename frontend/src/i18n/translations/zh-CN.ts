export default {
  ...
  "account.shares.modal.security.max-views": "最大访问次数",
  "account.shares.modal.security.ip-access": "IP 访问限制",
  "account.shares.modal.security.allowed-ips": "允许的 IP",
  "account.shares.modal.security.assigned-ips": "已占用的 IP",
  "account.shares.modal.security.enabled": "已启用",
  "account.shares.modal.security.disabled": "未启用",
  "account.shares.modal.security.no-limit": "不限制",
  "account.shares.modal.security.ip-mode.allowed-ips":
    "{count, plural, =1 {1 个指定 IP} other {# 个指定 IP}}",
  "account.shares.modal.security.ip-mode.max-ips": "前 {count} 个 IP",
  ...
  "upload.modal.accordion.security.ip-mode.label": "IP 访问限制",
  "upload.modal.accordion.security.ip-mode.disabled": "关闭",
  "upload.modal.accordion.security.ip-mode.max-ips": "前 N 个 IP",
  "upload.modal.accordion.security.ip-mode.allowed-ips": "指定 IP",
  "upload.modal.accordion.security.max-ips.label": "最大唯一 IP 数量",
  "upload.modal.accordion.security.max-ips.placeholder": "例如 3",
  "upload.modal.accordion.security.ip-allowed.label": "允许的 IP 地址",
  "upload.modal.accordion.security.ip-allowed.placeholder":
    "添加 IPv4 或 IPv6 地址",
  "upload.modal.accordion.security.ip-allowed.description":
    "每项填写一个 IPv4 或 IPv6 地址。只有这些 IP 可以访问。",
  ...
  "share.error.ip-not-allowed.title": "当前 IP 不允许访问",
  "share.error.ip-not-allowed.description":
    "你的当前 IP 地址不在允许访问此共享的范围内。",
  "share.error.ip-limit-exceeded.title": "IP 名额已满",
  ...
  "share.notify.copy-not-supported-error": "复制到剪贴板需要安全的 HTTPS 连接",
  ...
  "admin.config.config-file-warning.description":
    "由于您已配置了Pingvin 共享的配置文件，您无法通过UI更改配置。",
  ...
  "admin.config.share.allow-admin-access-all-shares": "允许管理员访问所有共享",
  ...
  "admin.config.share.files-json-web-view-links-enabled.description":
    "启用后，files.json 会为受支持的文本类文件、图片、音频、视频和 PDF 返回 webViewUrl，files.txt 会返回网页预览地址。该链接会以内联方式直接渲染内容，不会触发下载，适合无法下载附件的抓取器。",
