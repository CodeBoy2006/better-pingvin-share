export default {
  ...
  "home.bullet.a.description": "Better Pingvin Shareをあなたのマシンでホストしましょう。",
  ...
  "admin.config.config-file-warning.description": "設定ファイル設定で済みのBetter Pingvin ShareはUI を使用して設定を変更することはできません。",
  ...
  "admin.config.general.app-url.description": "Better Pingvin Shareで利用できるURL",
  ...
  "admin.config.cache.redis-enabled.description": "通常、Better Pingvin Share は情報をメモリ内にキャッシュします。複数の Better Pingvin Share インスタンスを実行する場合は、インスタンス間でキャッシュを共有するために Redis キャッシュを有効にする必要があります。",
