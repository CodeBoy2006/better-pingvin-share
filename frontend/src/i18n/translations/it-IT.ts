export default {
  ...
  "home.bullet.a.description": "Configura Better Pingvin Share sul tuo server.",
  ...
  "admin.config.config-file-warning.description": "Poiché hai configurato Better Pingvin Share tramite un file di configurazione, non ti è possibile modificare la configurazione dall'interfaccia utente.",
  ...
  "admin.config.general.app-url.description": "Su quale URL Better Pingvin Share è pubblicato",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente Better Pingvin Share mantiene la cache in memoria. Se si eseguono più istanze di Better Pingvin Share, è necessario abilitare il caching di Redis per condividere la cache tra le istanze.",
