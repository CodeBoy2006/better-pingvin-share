export default {
  ...
  "home.bullet.a.description": "Better Pingvin Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "Better Pingvin Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "Better Pingvin Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde Better Pingvin Share bilgileri bellekte önbellekler. Birden fazla Better Pingvin Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
