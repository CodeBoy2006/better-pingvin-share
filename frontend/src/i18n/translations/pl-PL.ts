export default {
  ...
  "home.bullet.a.description": "Utrzymuj Better Pingvin Share na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL Better Pingvin Share jest dostępny",
