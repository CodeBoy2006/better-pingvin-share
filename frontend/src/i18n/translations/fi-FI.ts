export default {
  ...
  "home.bullet.a.description": "Isännöi \"Better Pingvin Share\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella Better Pingvin Share on saatavilla",
