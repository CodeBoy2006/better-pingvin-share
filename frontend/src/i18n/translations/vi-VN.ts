export default {
  ...
  "home.bullet.a.description": "Host Better Pingvin Share on your own machine.",
  ...
  "admin.config.general.app-url.description": "On which URL Better Pingvin Share is available",
