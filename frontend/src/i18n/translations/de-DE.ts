export default {
  ...
  "home.bullet.a.description": "Betreibe Better Pingvin Share auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da Better Pingvin Share mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL Better Pingvin Share verfügbar ist",
