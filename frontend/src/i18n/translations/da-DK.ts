export default {
  ...
  "home.bullet.a.description": "Host Better Pingvin Share på din egen maskine.",
  ...
  "admin.config.general.app-url.description": "På hvilken URL Better Pingvin Share er tilgængelig",
