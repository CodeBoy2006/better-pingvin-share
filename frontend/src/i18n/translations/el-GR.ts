export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το Better Pingvin Share στο δικό σας μηχάνημα.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured Better Pingvin Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το Better Pingvin Share είναι διαθέσιμο",
