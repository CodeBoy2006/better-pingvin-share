export default {
  ...
  "home.bullet.a.description": "Hostujte Better Pingvin Share na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali Better Pingvin Share pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan Better Pingvin Share",
  ...
  "admin.config.cache.redis-enabled.description": "Better Pingvin Share obično kešira informacije u memoriji. Ako pokrećete više instanci Better Pingvin Share-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
