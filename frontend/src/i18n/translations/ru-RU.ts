export default {
  ...
  "home.bullet.a.description": "Better Pingvin Share работает на вашей машине.",
  ...
  "admin.config.general.app-url.description": "Адрес на котором доступен Better Pingvin Share",
